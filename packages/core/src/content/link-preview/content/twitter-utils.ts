...
const TWITTER_BLOCKED_TEXT_PATTERN =
  /something went wrong|try again|privacy related extensions|please disable them and try again|nitter\.net is offline|nitter.*cease[- ]and[- ]desist|nitter development stopped/i;
