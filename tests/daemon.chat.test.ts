...
describe("daemon/chat", () => {
  ...
  it("passes configured OpenAI base URL for auto-selected sidepanel chat models", async () => {
    const home = mkdtempSync(join(tmpdir(), "summarize-daemon-chat-auto-openai-base-"));
