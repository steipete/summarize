...
- Windows containers: `summarize daemon install` does not register a Scheduled Task. Run it manually each time the container starts or add that command to your container startup, and publish port `8787` so the host browser can reach the daemon.
